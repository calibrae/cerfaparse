...
export { mapLabelsToFields, generateFieldName, deduplicateName } from './map-labels.js';
export { extractDotLineFields, isDotLine } from './extract-dot-lines.js';
export type { DotLineResult } from './extract-dot-lines.js';
